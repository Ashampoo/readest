...
const title = 'Ashampoo E-Book Reader - Where You Read, Digest and Get Insight';
const description =
  'Discover Ashampoo E-Book Reader, the ultimate online ebook reader for immersive and organized reading. ' +
...
export const metadata = {
  ...
  keywords: ['epub', 'pdf', 'ebook', 'reader', 'ashampoo', 'pwa'],
  authors: [
    {
      name: 'readest',
  ...
  return (
    <html lang='en'>
      <head>
        ...
        <meta name='apple-mobile-web-app-title' content='Ashampoo E-Book Reader' />
